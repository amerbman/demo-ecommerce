  ...
  return (
    <main className="container mx-auto py-16 space-y-12">
      ...
      <section>
        ...
        <p className="text-lg leading-relaxed">{t('ourStory.content')}</p>
      </section>

      <section>
        <h2 className="text-2xl font-semibold mb-4">{t('ourMission.title')}</h2>
        <p className="text-lg leading-relaxed">{t('ourMission.content')}</p>
      </section>

      <section>
        <h2 className="text-2xl font-semibold mb-4">{t('meetTeam')}</h2>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <div className="border rounded p-4 text-center">
            ...
            />
            <h3 className="font-medium">{t('team.jane.name')}</h3>
            <p>{t('team.jane.title')}</p>
          </div>
          {/* John Smith */}
          <div className="border rounded p-4 text-center">
            <Image
              ...
              className="mx-auto mb-2 rounded-full object-cover"
            />
            <h3 className="font-medium">{t('team.john.name')}</h3>
            <p>{t('team.john.title')}</p>
          </div>
          {/* …more team cards */}
        </div>
      </section>
